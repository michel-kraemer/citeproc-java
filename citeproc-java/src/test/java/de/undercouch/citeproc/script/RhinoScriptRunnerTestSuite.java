...
/**
 * Makes sure a citeproc-related tests run with the {@link RhinoScriptRunner}
 * @author Michel Kraemer
 */
@RunWith(Suite.class)
@SuiteClasses({ CSLTest.class, BibTeXItemDataProviderTest.class })
public class RhinoScriptRunnerTestSuite {
	...
	public static void setUp() {
		prev = ScriptRunnerFactory.setRunnerType(RunnerType.RHINO);
	}
