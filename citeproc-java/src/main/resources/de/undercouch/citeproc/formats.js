...
CSL.Output.Formats.latexbbl = {
	"text_escape": function (text) {
		...
		return text.replace(/\\$/g, "\\$")
			...
			.replace(CSL.SUPERSCRIPTS_REGEXP,
					function(aChar) {
						return "\textsuperscript{" + CSL.SUPERSCRIPTS[aChar] + "}";
					});
	},
	
	"bibstart": "\\begin{thebibliography}{$$$__MAX_OFFSET__$$$}\n",
	"bibend": "\\end{thebibliography}",
	"@passthrough/true": CSL.Output.Formatters.passthrough,
	
	"@font-style/italic": "\\textit{%%STRING%%}",
	"@font-style/oblique": "\\emph{%%STRING%%}",
	"@font-style/normal": "\\textnormal{%%STRING%%}",
	
	"@font-variant/small-caps": "\\textsc{%%STRING%%}",
	"@font-variant/normal": "\\textnormal{%%STRING%%}",
	
	"@font-weight/bold": "\\textbf{%%STRING%%}",
	"@font-weight/normal": "\\textnormal{%%STRING%%}",
	"@font-weight/light": false,
	
	"@text-decoration/none": "\\textnormal{%%STRING%%}",
	"@text-decoration/underline": "\\underline{%%STRING%%}",
	...
	"@bibliography/entry": function (state, str) {
		return "\\bibitem{" + this.system_id + "}" + str + "\n";
	},
	...
	"@DOI/true": function (state, str) {
		return "\\href{http://dx.doi.org/" + str + "}{" + str + "}";
	}
};
