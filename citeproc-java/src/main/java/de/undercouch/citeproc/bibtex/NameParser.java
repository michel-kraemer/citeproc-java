...
public class NameParser {
    /**
     * <p>Parses names to {@link CSLName} objects. Also handles strings
     ...
     * contains a literal string.</p>
     *
     * <p>Special handling is provided for names enclosed in braces {},
     * which are meant to be preserved as-is in the output.</p>
     *
