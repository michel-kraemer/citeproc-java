...
public class OAuth {
	 ...
	 * @param callback a callback URL used during authorization (or
	 * {@link #CALLBACK_OOB} if the client is unable to receive callbacks)
	 ...
	 */
	public Token requestTemporaryCredentials(URL url, Method method, String callback)
			throws IOException {
		Map<String, String> aap = new HashMap<String, String>();
		aap.put(OAUTH_CALLBACK, callback);
	 ...
	 * {@link #requestTemporaryCredentials(URL, Method, String)}
